...
class DNX64:
    def __init__(self, dll_path: str) -> None:
        ...
        try:
            ...
            msg = str(e)
            if "not a valid Win32 application" in msg:
                sys.stderr.write(f"DNX64: LOAD FAILED: {dll_name} is corrupted. Please REPLACE the DLL from your original Dino-Lite SDK.\n")
